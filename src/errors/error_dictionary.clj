...
(def error-dictionary
  [
   ...
   :make-msg-info-obj (fn [matches] (make-msg-info-hashes "The function " (get-function-name (nth matches 1))
    ...
    :make-msg-info-obj (fn [matches] (make-msg-info-hashes "There is no method " (nth matches 1) " with " (number-arg (nth matches 2)) " or with this type of argument(s)" (get-common-class (nth matches 3)) ".\n"))}

    ;; Note: could be a field or a method call with no args
    {:key :no-field-found
    :class "IllegalArgumentException"
    :match (beginandend #"No matching field found: (.+) for class (.+)")
    :make-msg-info-obj (fn [matches] (make-msg-info-hashes "There is no method " (nth matches 1) " with no arguments or a field " (nth matches 1) (get-common-class (nth matches 2)) ".\n"))}
    ...
    :make-msg-info-obj (fn [matches] (make-msg-info-hashes "Expected an integer number, but a sequence "
                                                            (nth matches 1) " was given instead.\n"))}
